...
export function Header() {
  return (
    <header className="flex items-center border-b border-b-zinc-300 dark:border-b-zinc-700 sticky top-0 w-full backdrop-blur-[20px] backdrop-saturate-150 bg-white/50 dark:bg-[#0D0D1050]">
